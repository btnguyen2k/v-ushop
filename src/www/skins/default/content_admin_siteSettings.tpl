...
><!-- Middle column full box -->
    <div class="middle-column-box-green">
        ...
        <form method="post" action="[:$MODEL.form.action:]" name="[:$MODEL.form.name|escape:'html':]">
            ...
            <input type="text" name="siteTitle" value="[:$MODEL.form.siteTitle|escape:'html':]" style="width: 98%" />
            <br/>
            <label>[:$MODEL.language->getMessage('msg.siteKeywords'):]:</label>
            <input type="text" name="siteKeywords" value="[:$MODEL.form.siteKeywords|escape:'html':]" style="width: 98%" />
            <br/>
            <label>[:$MODEL.language->getMessage('msg.siteDescription'):]:</label>
            <input type="text" name="siteDescription" value="[:$MODEL.form.siteDescription|escape:'html':]" style="width: 98%" />
            <br/>
            <label>[:$MODEL.language->getMessage('msg.siteCopyright'):]:</label>
            <input type="text" name="siteCopyright" value="[:$MODEL.form.siteCopyright|escape:'html':]" style="width: 98%" />
            <br/>
