...
><!-- Middle column full box -->
    <div class="middle-column-box-green">
        <div class="middle-column-box-title-green">[:$MODEL.language->getMessage('msg.editItem'):]</div>
        <form method="post" action="[:$MODEL.form.action:]" name="[:$MODEL.form.name|escape:'html':]" enctype="multipart/form-data">
            ...
            <textarea id="editItemDescription" rows="16" name="itemDescription" style="width: 98%">[:$MODEL.form.itemDescription|escape:'html':]</textarea>
        ...
        [:tinymce elName='editItemDescription':]
    </div>
</div>
