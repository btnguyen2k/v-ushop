...
><!-- Middle column full box -->
    <div class="middle-column-box-green">
        <div class="middle-column-box-title-green">[:$MODEL.language->getMessage('msg.editPage'):]</div>
        <form method="post" action="[:$MODEL.form.action:]" name="[:$MODEL.form.name|escape:'html':]">
            ...
            <textarea id="editPageContent" rows="16" name="pageContent" style="width: 98%">[:$MODEL.form.pageContent|escape:'html':]</textarea>
            <br/>
        ...
        [:tinymce elName='editPageContent':]
    </div>
</div>