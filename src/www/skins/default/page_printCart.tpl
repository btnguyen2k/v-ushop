...
<body >
	...
	<div align="center" style="height: 1000px;" >
        <div  class="container_12" style="height: 100%;background: #fff">        	
        	<br/><br/><br/><br/><br/>
        	<a id="print" class="print-preview" ctyle>Print this page</a>
        	<table  cellpadding="0" cellspacing="0" border="1" style="border-color: #DCDCDC;" align="center">
            	<thead class="table-header">  
                	<tr>        		
                		<th width="20px" ><input type="checkbox" class="checkbox" id="check-all" onchange="toggleChecked(this.checked)"> </th>
