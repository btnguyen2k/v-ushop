<?php
class Vushop_Controller_CreateItemController extends Vushop_Controller_BaseFlowController {
    const VIEW_NAME = 'create_item';
    ...
    protected function performFormSubmission() {
        ...
        $data = Array(Vushop_Bo_Catalog_BoItem::COL_ACTIVE => 1, 
                ...
                Vushop_Bo_Catalog_BoItem::COL_OWNER_ID => $ownerId);
