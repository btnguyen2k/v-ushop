...
$router = Array('*' => 'Vushop_Controller_HomeController', 
        ...
        'register' => 'Vushop_Controller_RegisterController', 
        ...
        'myOrders' => 'Vushop_Controller_MyOrdersController', 
        'changeStatusOrderDetail' => 'Vushop_Controller_ChangeStatusOrderDetailController', 
        'viewOrder' => 'Vushop_Controller_ViewOrderController', 
        ...
        'printCart' => 'Vushop_Controller_PrintCartController', 
        'updateCart' => 'Vushop_Controller_UpdateCartController', 
