...
VALUES ('localhost', 'VCATALOG', 0, UNIX_TIMESTAMP(), -1, 0, 6, 0, '{"DB":{"TYPE":"MYSQL", "HOST":"127.0.0.1", "USER":"vcatalog_local", "PASSWORD":"vcatalog_local", "DATABASE":"vcatalog_local", "SETUP_SQLS":["SET NAMES ''utf8''"]}}');
